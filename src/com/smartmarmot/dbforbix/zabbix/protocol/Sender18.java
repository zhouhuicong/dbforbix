...
//			return data.getBytes("ASCII");   //  in the ASCII encoding
	...
	private String buildJSonString(String host, String item, String value, String clock) {
		 String head = "<request><host>" + base64Encode(host) + "</host><key>";
	...
	private String buildJSonString1(String host, String item, String value, String clock) {
